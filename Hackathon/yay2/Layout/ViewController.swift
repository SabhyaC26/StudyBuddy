...
class ViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let DIT = YourClasses(classname: "Download Ithaca Transit, Pollo, Etery, and Uplift!!")
        ...
        addClass.setTitle("+ add class button", for: .normal)
        ...
        presentModalViewControllerButton.setTitle("Your Classes-- this could be a list or a table view cell etc", for: .normal)
